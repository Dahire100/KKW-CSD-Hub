import { Semester, Practical, Contributor, Theme } from './types';

export const HERO_IMAGE = "/kkw-logo.png";
export const LOGO_URL = "/kkw-logo.png";
export const REPO_LINK = "https://github.com/Dahire100/KKW-CSD-Hub.git";
